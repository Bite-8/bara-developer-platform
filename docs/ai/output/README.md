...
Codex custom agents の最終成果物を agent ごとに保存します。Project-local の自律的な製品開発サイクルでは、Product Owner の決定、Project Manager の実行記録、実装、品質レビュー、製品レビューを後から追跡できる完成版だけを保存します。
...
- 担当 agent または Project Manager が成果物を保存します。保存者の違いで内容や採番規則を変えません。
